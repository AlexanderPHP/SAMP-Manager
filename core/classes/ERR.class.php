...
class ERR
{
	...
	{
		$this->error_filename = $_SERVER['DOCUMENT_ROOT'] . '/core/logs/error_log.txt';
		...
		if (is_writable($this->error_filename) && file_exists($this->error_filename))
		{
